...
const Patients = React.lazy(() => import('./views/patients-management/Patients'))
const NewPatient = React.lazy(() => import('./views/patients-management/NewPatient'))
...
const routes = [
  ...
  { path: '/patients-management', name: 'Patients Management', element: Patients },
  { path: '/queue', name: 'Queue', element: Queue },
  { path: '/new-patient', name: 'New Patient', element: NewPatient },
  { path: '/patient/:id', name: 'Patient Profile', element: PatientProfile },
